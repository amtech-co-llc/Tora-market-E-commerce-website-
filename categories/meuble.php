...
<head>
    ...
    <title>Meubles & Electroménagere</title>
            ...
            <div class="users-card">
                ...
                <a href="../categorie-results.php?sous-categorie=fourniture-de-jardin">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Fournitures de jardin</h3>
                            <p>tout les Fournitures</p>
                        </div>
                    </div>
                </a>
                <!-- end of user-card -->
                ...
                <a href="../categorie-results.php?sous-categorie=appareil-de-cuisine">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Appareils de cuisine</h3>
                            <p>tout les Appareils</p>
                        </div>
                    </div>
                </a>
                <!-- end of user-card -->
                ...
                <a href="../categorie-results.php?sous-categorie=produit-chimique-menagers">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Produit chimique ménagers</h3>
                            <p>produits nécessaires</p>
                        </div>
                    </div>
                </a>
                <!-- end of user-card -->
