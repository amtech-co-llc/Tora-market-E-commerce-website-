            ...
            <div class="users-card">
                ...
                <a href="../categorie-results.php?sous-categorie=fours-industriels" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Fours Industriels</h3>
                            <p>Tous les Catégories & Modèles</p>
                        </div>
                    </div>
                </a>
                <!-- end of user-card -->
                ...
                <a href="../categorie-results.php?sous-categorie=equipement-de-frabication" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Equipements de Fabrication</h3>
                ...
                <a href="../categorie-results.php?sous-categorie=materiaux-et-outils-de-fabrication" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Matériaux & Outils de Fabrication</h3>
                            <p>Tous les catégories</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="../categorie-results.php?sous-categorie=equipements-dimpression" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Equipements d'impression</h3>
                            <p>Tous les catégories</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="../categorie-results.php?sous-categorie=equipements-de-restauration" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Equipements de restauration</h3>
                            <p>Tous les catégories</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="../categorie-results.php?sous-categorie=eclairage-de-scene-et-effets" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Eclairage de scène & effets</h3>
                            <p>Tous les catégories</p>
                        </div>
                    </div>
                </a>
