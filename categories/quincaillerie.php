...
<head>
    ...
    <title>Quincaillerie & Construction</title>
            ...
            <div class="users-card">
                ...
                <a href="../categorie-results.php?sous-categorie=plomberie-et-approvisionnement-deau">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Plomberie & Approvisionnement d'eau</h3>
                            <p>Tous les Articles & Matériaux</p>
                        </div>
                    </div>
                </a>
                <!-- end of user-card -->
                ...
                <a href="../categorie-results.php?sous-categorie=autres-articles-de-reparation-et-construction">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Autres Articles de Réparation & Construction</h3>
                            <p>Tous les catégories</p>
                        </div>
                    </div>
                </a>
