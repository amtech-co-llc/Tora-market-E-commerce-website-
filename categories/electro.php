            ...
            <div class="users-card">
                ...
                <a href="../categorie-results.php?sous-categorie=accesoire-et-fourniture-pour-electronique" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Accesoires & fournitures pour électronique</h3>
                ...
                <a href="../categorie-results.php?sous-categorie=equipement-audio-et-musique" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Equipements audio & Musique</h3>
                ...
                <a href="../categorie-results.php?sous-categorie=equipement-reseau" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            ...
                            <p>tous les équipement réseau</p>
                        </div>
                    </div>
                </a>
                <!-- end of user-card -->
                ...
                <a href="../categorie-results.php?sous-categorie=logiciels" class="a-user">
                    <div class="user-card">
                        ...
                        <div class="det-user">
                            <h3>Logiciels</h3>
                            <p>tous les logiciels nécessaires</p>
                        </div>
                    </div>
                </a>
                <!-- end of user-card -->
